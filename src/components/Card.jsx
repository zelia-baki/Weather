      ...
      <div className="px-6 py-4 bg-gray-100">
        ...
        <div className="flex flex-col gap-6 mb-6">
          <div className="flex items-center gap-4">
            <label htmlFor="region" className="text-gray-800 font-semibold w-1/3">Région :</label>
            <select
              id="region"
              value={region}
          ...
          <div className="flex items-center gap-4">
            <label htmlFor="crop" className="text-gray-800 font-semibold w-1/3">Culture :</label>
            <select
              id="crop"
              value={crop}
        ...
        <div className="text-gray-800 text-lg mb-6">
          <p className="mb-2">
            <strong className="text-gray-600">Culture :</strong> {crop}
          </p>
          <p>
            <strong className="text-gray-600">Nom de la Ferme :</strong> {currentData.farmName}
          </p>
        </div>
      </div>
      <img className="w-full h-48 object-cover" src={currentData.imageUrl} alt={`Photo de ${region}`} />

      <div className="px-6 py-4 bg-gray-50">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex items-center text-gray-600">
            <FaThermometerHalf className="text-red-500 mr-3 text-2xl" />
            <div className="font-semibold w-1/2">Température :</div>
          ...
          <div className="flex items-center text-gray-600">
            ...
            <div className="font-semibold w-1/2">Humidité :</div>
          ...
          <div className="flex items-center text-gray-600">
            ...
            <div className="font-semibold w-1/2">Radiation Solaire :</div>
          ...
          <div className="flex items-center text-gray-600">
            ...
            <div className="font-semibold w-1/2">Vitesse du Vent :</div>
          ...
          <div className="flex items-center text-gray-600">
            ...
            <div className="font-semibold w-1/2">Pression :</div>
        ...
        <div className="px-4 py-2 bg-gray-100 mt-4 rounded-lg shadow-md">
          <div className="flex items-center text-gray-600 mb-2">
            ...
            <div className="text-gray-800 text-xl w-1/2 text-right">{currentData.ET0} mm/jour</div>
          </div>
          <div className="flex items-center text-gray-600">
            <FaSun className="text-yellow-500 mr-3 text-2xl" />
            <div className="font-semibold w-1/2">ETc :</div>
            <div className="text-gray-800 text-xl w-1/2 text-right">{currentData.ETc} mm/jour</div>
          </div>
        </div>
      </div>
    </div>
