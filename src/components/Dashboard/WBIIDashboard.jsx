...
const WBIIDashboard = () => {
  ...
  const calculateWBII = (weatherData) => {
    ...
    for (let i = 0; i < daily.time.length; i++) {
      ...
      const isForecast = dateObj > today;
  ...
  <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center p-8">
    <div className="bg-white rounded-3xl shadow-lg border border-red-100 p-12 max-w-md w-full text-center">
      ...
      >
        Retour
          ...
          {expandedInfo && (
            <div className="mt-6 p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-100">
              ...
              <div className="bg-white p-5 rounded-2xl border border-purple-100 mb-4">
                <h4 className="font-semibold text-sm text-gray-900 mb-4 flex items-center gap-2">
                  <Activity className="w-4 h-4 text-purple-500" />
                  WBII Calculation Formula
                </h4>
                <div className="mb-4">
                  <p className="text-xs font-semibold text-gray-700 mb-2 uppercase tracking-wide">
                    1 · Temperature Stress (0 – 50)
                  </p>
                  <div className="bg-orange-50 border border-orange-100 rounded-xl p-3 space-y-1 font-mono text-xs text-orange-900">
                    <p>if tempAvg &lt; 20°C → <span className="font-bold">((20 − tempAvg) / 5) × 50</span></p>
                    <p>if tempAvg &gt; 28°C → <span className="font-bold">((tempAvg − 28) / 7) × 50</span></p>
                    <p>if 20°C ≤ tempAvg ≤ 28°C → <span className="font-bold">0</span></p>
                  </div>
                </div>
                <div className="mb-4">
                  <p className="text-xs font-semibold text-gray-700 mb-2 uppercase tracking-wide">
                  ...
                  <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 space-y-1 font-mono text-xs text-blue-900">
                    <p>if precipitation &gt; 10mm → <span className="font-bold">min(50, ((precip − 10) / 10) × 50)</span></p>
                    <p>if precipitation &lt; 1mm  → <span className="font-bold">25</span> (drought)</p>
                    <p>if 1mm ≤ precipitation ≤ 10mm → <span className="font-bold">0</span></p>
                  </div>
                </div>
                <div>
                  <p className="text-xs font-semibold text-gray-700 mb-2 uppercase tracking-wide">
                  ...
                  <div className="bg-purple-50 border border-purple-200 rounded-xl p-3 font-mono text-xs text-purple-900">
                    <p className="text-sm font-bold">WBII = min(100, tempStress + waterStress)</p>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-xl">
                  ...
                  <div className="space-y-1 text-xs">
                    <div className="flex justify-between"><span className="text-green-600">0 - Optimal</span><span className="text-gray-500">20-28°C</span></div>
                    <div className="flex justify-between"><span className="text-yellow-600">&lt;15 - Low Stress</span><span className="text-gray-500">18-19°C or 29-30°C</span></div>
                    <div className="flex justify-between"><span className="text-orange-600">15-25 - Moderate</span><span className="text-gray-500">16-17°C or 31-32°C</span></div>
                    <div className="flex justify-between"><span className="text-red-600">25-35 - High</span><span className="text-gray-500">15°C or 33-34°C</span></div>
                    <div className="flex justify-between"><span className="text-red-700">35+ - Critical</span><span className="text-gray-500">&lt;15°C or &gt;35°C</span></div>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-xl">
                  <h4 className="font-semibold text-sm text-gray-900 mb-2 flex items-center gap-2">
                  ...
                  <div className="space-y-1 text-xs">
                    <div className="flex justify-between"><span className="text-green-600">0 - Optimal</span><span className="text-gray-500">1-10mm rainfall</span></div>
                    <div className="flex justify-between"><span className="text-yellow-600">25 - Drought</span><span className="text-gray-500">&lt;1mm rainfall</span></div>
                    <div className="flex justify-between"><span className="text-orange-600">25-40 - Heavy Rain</span><span className="text-gray-500">10-20mm rainfall</span></div>
                    <div className="flex justify-between"><span className="text-red-600">40+ - Extreme Rain</span><span className="text-gray-500">&gt;20mm rainfall</span></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Detailed Weather Event Statistics */}
        {detailedStats && (
          <div className="bg-white rounded-3xl shadow-lg border border-purple-100 p-8">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-2xl border-2 border-blue-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold text-blue-700 bg-blue-200 px-2 py-1 rounded-full">&gt; 10mm</span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 p-5 rounded-2xl border-2 border-cyan-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold text-cyan-700 bg-cyan-200 px-2 py-1 rounded-full">5-10mm</span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-sky-50 to-sky-100 p-5 rounded-2xl border-2 border-sky-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold text-sky-700 bg-sky-200 px-2 py-1 rounded-full">1-5mm</span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-5 rounded-2xl border-2 border-amber-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold text-amber-700 bg-amber-200 px-2 py-1 rounded-full">&lt; 1mm</span>
                  </div>
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                  <div><span className="text-gray-600">Total precipitation:</span><span className="ml-2 font-bold text-blue-700">{detailedStats.totalPrecip}mm</span></div>
                  <div><span className="text-gray-600">Daily average:</span><span className="ml-2 font-bold text-blue-700">{detailedStats.avgPrecip}mm</span></div>
                  <div><span className="text-gray-600">Maximum recorded:</span><span className="ml-2 font-bold text-blue-700">{detailedStats.maxPrecip}mm</span></div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-red-50 to-red-100 p-5 rounded-2xl border-2 border-red-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold text-red-700 bg-red-200 px-2 py-1 rounded-full">&gt; 35°C</span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-5 rounded-2xl border-2 border-orange-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold text-orange-700 bg-orange-200 px-2 py-1 rounded-full">&gt; 29°C</span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 p-5 rounded-2xl border-2 border-cyan-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold text-cyan-700 bg-cyan-200 px-2 py-1 rounded-full">&lt; 20°C</span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-2xl border-2 border-blue-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold text-blue-700 bg-blue-200 px-2 py-1 rounded-full">&lt; 15°C</span>
                  </div>
              ...
              <div className="mt-4 p-4 bg-orange-50 rounded-xl border border-orange-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                  <div><span className="text-gray-600">Average temperature:</span><span className="ml-2 font-bold text-orange-700">{detailedStats.avgTemp}°C</span></div>
                  <div><span className="text-gray-600">Maximum recorded:</span><span className="ml-2 font-bold text-red-700">{detailedStats.maxTemp}°C</span></div>
                  <div><span className="text-gray-600">Minimum recorded:</span><span className="ml-2 font-bold text-blue-700">{detailedStats.minTemp}°C</span></div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* ─── Main Chart — le ref est posé ICI sur le div wrapper ─── */}
        {loading ? (
            ...
            <div className="mb-6 p-5 bg-gradient-to-r from-gray-50 to-purple-50 rounded-2xl border border-gray-200">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <div><p className="text-xs font-semibold text-gray-900">Low</p><p className="text-xs text-gray-500">0-20</p></div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 bg-yellow-500 rounded-lg shadow-sm"></div>
                  <div><p className="text-xs font-semibold text-gray-900">Moderate</p><p className="text-xs text-gray-500">20-40</p></div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 bg-orange-500 rounded-lg shadow-sm"></div>
                  <div><p className="text-xs font-semibold text-gray-900">High</p><p className="text-xs text-gray-500">40-60</p></div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 bg-red-500 rounded-lg shadow-sm"></div>
                  <div><p className="text-xs font-semibold text-gray-900">Critical</p><p className="text-xs text-gray-500">60+</p></div>
                </div>
              </div>
            </div>

            {/* ↓↓↓ Le ref est placé sur ce div qui englobe le graphique ↓↓↓ */}
            <div ref={chartRef} style={{ background: '#ffffff', borderRadius: 12, padding: '8px 0' }}>
                ...
                return (
                  <div key={idx} className="bg-gradient-to-br from-red-50 to-orange-50 p-5 rounded-2xl border-2 border-red-200 hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="bg-red-100 text-red-700 text-xs font-bold px-3 py-1 rounded-full">WBII: {day.wbii}</span>
                        {day.isForecast && <span className="bg-blue-100 text-blue-700 text-xs font-bold px-2 py-1 rounded-full">Forecast</span>}
                      </div>
                    </div>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center justify-between">
                        <span className="text-gray-600 flex items-center gap-1"><ThermometerSun className="w-3.5 h-3.5" />Temperature</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-gray-600 flex items-center gap-1"><Droplets className="w-3.5 h-3.5" />Rainfall</span>
