    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-8 md:px-16">
      ...
      <div className="flex space-x-6">
        <ActionButton 
          ...
          icon={<FaSignInAlt className="w-6 h-6 mr-2" />} 
          label="Login" 
        />
        <ActionButton 
          href="#" 
          ...
          icon={<FaUserPlus className="w-6 h-6 mr-2" />} 
          label="Contact Us" 
        />
      </div>
    </div>
...
const Footer = () => (
  <footer className="bg-gray-900 text-white py-8 mt-8 text-center">
    <p>&copy; 2024 Farm Management App. All rights reserved.</p>
    <motion.a 
