    ...
    <div className="flex justify-center flex-col items-center text-xl">
      ...
      <div ref={reportRef}>
        ...
        <div className="page bg-white p-6 shadow-md mb-4">
          ...
          {forestInfo && (
            <p className="p-4">
              This report provides an overview of Forest ID <strong>{forestInfo.farm_id}</strong>, owned by <strong>{forestInfo.name}</strong>,
              {forestInfo.crops && forestInfo.crops.length > 0 ? (
                <>
                  the farm specializes in <strong>{forestInfo.crops[0].crop}</strong> and operates within a region characterized by Landtype: <strong>{forestInfo.crops[0].land_type}</strong>.
                </>
              ) : (
