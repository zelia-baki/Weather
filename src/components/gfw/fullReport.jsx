...
const FullReport = () => {
  ...
  const coverLossArea = geoData["tree cover loss"]?.[0]?.data_fields?.area__ha;
        ...
        <div className="page bg-white p-6 shadow-md mb-4">
            ...
            <table className="table-auto w-full mt-4 border-collapse border border-gray-400">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-400 px-4 py-2">
                    {geoData['radd alerts']?.[0]?.data_fields.area__ha === '0' || geoData['radd alerts']?.[0]?.data_fields.area__ha === 0 ? (
                      <div>
                        <p>{geoData['radd alerts']?.[0]?.data_fields.area__ha} ha (no Radd alert)</p>
                      </div>
                    ) : (
                ...
                <tr>
                  ...
                  <td className="border border-gray-400 px-4 py-2">
                    {geoData['tree cover loss']?.[0]?.data_fields.area__ha === '0' || geoData['tree cover loss']?.[0]?.data_fields.area__ha === 0 ? (
                      <div>
                        <p>{geoData['tree cover loss']?.[0]?.data_fields.area__ha} ha (no tree loss since 2020)</p>
                      </div>
                    ) : (
                ...
                <tr>
                  ...
                  <td className="border border-gray-400 px-4 py-2">
                    ...
                    <p>{tscDriverDriver?.mostCommonValue || "Unknown driver"}</p>
                ...
                <tr>
                  ...
                  <td className="border border-gray-400 px-4 py-2">
                    ...
                    {geoData['wri tropical tree cover extent']?.[0]?.data_fields.area__ha === '0' || geoData['wri tropical tree cover extent']?.[0]?.data_fields.area__ha === 0 ? (
                      <div>
                        <p>{geoData['wri tropical tree cover extent']?.[0]?.data_fields.area__ha} ha (LOW)</p>
                      </div>
                    ) : (
          ...
          <div className="items-center justify-center mt-6 mb-6">
            <div className="overflow-hidden">
              <img
                src={generateMapboxUrl(geoData['radd alerts']?.[0]?.coordinates[0])}
